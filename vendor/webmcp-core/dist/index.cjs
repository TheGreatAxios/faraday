...
__export(index_exports, {
  WEBMCP_TAGS: () => WEBMCP_TAGS,
  WebMCPJourneyElement: () => WebMCPJourneyElement,
  WebMCPProviderElement: () => WebMCPProviderElement,
  assertToolName: () => assertToolName,
  cleanupPolyfill: () => cleanupPolyfill,
  createPageBridgeClient: () => createPageBridgeClient,
  createToolRegistry: () => createToolRegistry,
  executeToolForBridge: () => executeToolForBridge,
  experimental_createJourneyRegistry: () => experimental_createJourneyRegistry,
  experimental_defineJourney: () => experimental_defineJourney,
  getJourneyRegistry: () => getJourneyRegistry,
  getRegistry: () => getRegistry,
  installPolyfill: () => installPolyfill,
  isNativeModelContext: () => isNativeModelContext,
  listBridgeToolSummaries: () => listBridgeToolSummaries,
  parseToolArgsJson: () => parseToolArgsJson,
  registerWebMCPElements: () => registerWebMCPElements,
  setJourneyRegistry: () => setJourneyRegistry,
  validateToolDescriptor: () => validateToolDescriptor
});
